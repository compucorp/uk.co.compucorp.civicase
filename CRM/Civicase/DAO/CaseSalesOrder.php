 ...
 * (GenCodeChecksum:9005e932abd51d51dc17105e0a28bd0a)
 */
...
class CRM_Civicase_DAO_CaseSalesOrder extends CRM_Core_DAO {
   ...
   * @var string
   */
  public static $_tableName = 'civicrm_case_sales_order';
  ...
  public function __construct() {
    $this->__table = 'civicrm_case_sales_order';
    parent::__construct();
  }
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'required' => TRUE,
          'where' => 'civicrm_case_sales_order.id',
          'table_name' => 'civicrm_case_sales_order',
        ...
        'client_id' => [
          ...
          'where' => 'civicrm_case_sales_order.client_id',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
          'localizable' => 0,
        ...
        'owner_id' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'description' => E::ts('FK to Contact'),
          'where' => 'civicrm_case_sales_order.owner_id',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
          'localizable' => 0,
        ...
        'case_id' => [
          ...
          'where' => 'civicrm_case_sales_order.case_id',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
          'localizable' => 0,
        ...
        'currency' => [
          ...
          'import' => TRUE,
          'where' => 'civicrm_case_sales_order.currency',
        ...
        'status_id' => [
          ...
          'required' => TRUE,
          'where' => 'civicrm_case_sales_order.status_id',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
          'localizable' => 0,
        ...
        'description' => [
          ...
          'required' => FALSE,
          'where' => 'civicrm_case_sales_order.description',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
          'localizable' => 0,
        ...
        'notes' => [
          ...
          'required' => FALSE,
          'where' => 'civicrm_case_sales_order.notes',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
          'localizable' => 0,
        ...
        'total_before_tax' => [
          ...
          'where' => 'civicrm_case_sales_order.total_before_tax',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
          'localizable' => 0,
        ...
        'total_after_tax' => [
          ...
          'where' => 'civicrm_case_sales_order.total_after_tax',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
          'localizable' => 0,
        ...
        'quotation_date' => [
          ...
          'where' => 'civicrm_case_sales_order.quotation_date',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
          'localizable' => 0,
        ...
        'created_at' => [
          ...
          'where' => 'civicrm_case_sales_order.created_at',
        ...
        'is_deleted' => [
          ...
          'where' => 'civicrm_case_sales_order.is_deleted',
          'default' => '0',
          'table_name' => 'civicrm_case_sales_order',
          'entity' => 'CaseSalesOrder',
          'bao' => 'CRM_Civicase_DAO_CaseSalesOrder',
  ...
  public static function &import($prefix = FALSE) {
    $r = CRM_Core_DAO_AllCoreTables::getImports(__CLASS__, 'case_sales_order', $prefix, []);
    return $r;
  }
  ...
  public static function &export($prefix = FALSE) {
    $r = CRM_Core_DAO_AllCoreTables::getExports(__CLASS__, 'case_sales_order', $prefix, []);
    return $r;
  }
